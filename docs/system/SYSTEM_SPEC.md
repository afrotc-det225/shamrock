...
- Frontend formatting must reset Sheets Table column types before clearing or applying normal cell-level data validation, because typed table columns block validation writes.
