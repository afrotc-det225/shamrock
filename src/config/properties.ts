...
namespace Config {
  export const PROPERTY_KEYS = {
    ...
    ATTENDANCE_FORM_REBUILD_STATE: 'ATTENDANCE_FORM_REBUILD_STATE',
    EXCUSALS_FORM_REBUILD_STATE: 'EXCUSALS_FORM_REBUILD_STATE',
    DIRECTORY_FORM_REBUILD_STATE: 'DIRECTORY_FORM_REBUILD_STATE',
  ...
  export const SCRIPT_PROPERTY_HELP = [
    ...
    { key: PROPERTY_KEYS.ATTENDANCE_FORM_REBUILD_STATE, description: 'Internal resumable state for finalizing an asynchronously created Attendance Form response tab.' },
    { key: PROPERTY_KEYS.EXCUSALS_FORM_REBUILD_STATE, description: 'Internal resumable state for finalizing an asynchronously created Excusals Form response tab.' },
    { key: PROPERTY_KEYS.DIRECTORY_FORM_REBUILD_STATE, description: 'Internal resumable state for finalizing an asynchronously created Directory Form response tab.' },
